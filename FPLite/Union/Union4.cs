...
namespace FPLite.Union
{
    ...
    public class Union<T1, T2, T3, T4> : IEquatable<Union<T1, T2, T3, T4>>
    {
        ...
        public Union<T1, T, T3, T4> Bind2<T>(Func<T2, T> func) => _type switch
        {
        ...
        public Union<T1, T2, T, T4> Bind3<T>(Func<T3, T> func) => _type switch
        {
        ...
        public Union<T1, T2, T3, T> Bind4<T>(Func<T4, T> func) => _type switch
        {
