...
namespace FPLite.Union
{
    ...
    public class Union<T1, T2, T3, T4> : IEquatable<Union<T1, T2, T3, T4>>
    {
        ...
        {
            2 => Union<T, T1, T3, T4>.Type1(func(_t2)),
            1 => Union<T, T1, T3, T4>.Type2(_t1),
        ...
        {
            3 => Union<T, T1, T2, T4>.Type1(func(_t3)),
            1 => Union<T, T1, T2, T4>.Type2(_t1),
            2 => Union<T, T1, T2, T4>.Type3(_t2),
        ...
        {
            4 => Union<T, T1, T2, T3>.Type1(func(_t4)),
            1 => Union<T, T1, T2, T3>.Type2(_t1),
            2 => Union<T, T1, T2, T3>.Type3(_t2),
            3 => Union<T, T1, T2, T3>.Type4(_t3),
        ...
        public override int GetHashCode() => HashCode.Combine(_type, _t1, _t2, _t3, _t4);
