...
namespace FPLite.Union
{
    ...
    public class Union<T1, T2, T3, T4, T5, T6, T7, T8> : IEquatable<Union<T1, T2, T3, T4, T5, T6, T7, T8>>
    {
        ...
        {
            2 => Union<T, T1, T3, T4, T5, T6, T7, T8>.Type1(func(_t2)),
            1 => Union<T, T1, T3, T4, T5, T6, T7, T8>.Type2(_t1),
        ...
        {
            3 => Union<T, T1, T2, T4, T5, T6, T7, T8>.Type1(func(_t3)),
            1 => Union<T, T1, T2, T4, T5, T6, T7, T8>.Type2(_t1),
            2 => Union<T, T1, T2, T4, T5, T6, T7, T8>.Type3(_t2),
        ...
        {
            4 => Union<T, T1, T2, T3, T5, T6, T7, T8>.Type1(func(_t4)),
            1 => Union<T, T1, T2, T3, T5, T6, T7, T8>.Type2(_t1),
            2 => Union<T, T1, T2, T3, T5, T6, T7, T8>.Type3(_t2),
            3 => Union<T, T1, T2, T3, T5, T6, T7, T8>.Type4(_t3),
        ...
        {
            5 => Union<T, T1, T2, T3, T4, T6, T7, T8>.Type1(func(_t5)),
            1 => Union<T, T1, T2, T3, T4, T6, T7, T8>.Type2(_t1),
            2 => Union<T, T1, T2, T3, T4, T6, T7, T8>.Type3(_t2),
            3 => Union<T, T1, T2, T3, T4, T6, T7, T8>.Type4(_t3),
            4 => Union<T, T1, T2, T3, T4, T6, T7, T8>.Type5(_t4),
        ...
        {
            6 => Union<T, T1, T2, T3, T4, T5, T7, T8>.Type1(func(_t6)),
            1 => Union<T, T1, T2, T3, T4, T5, T7, T8>.Type2(_t1),
            2 => Union<T, T1, T2, T3, T4, T5, T7, T8>.Type3(_t2),
            3 => Union<T, T1, T2, T3, T4, T5, T7, T8>.Type4(_t3),
            4 => Union<T, T1, T2, T3, T4, T5, T7, T8>.Type5(_t4),
            5 => Union<T, T1, T2, T3, T4, T5, T7, T8>.Type6(_t5),
        ...
        {
            7 => Union<T, T1, T2, T3, T4, T5, T6, T8>.Type1(func(_t7)),
            1 => Union<T, T1, T2, T3, T4, T5, T6, T8>.Type2(_t1),
            2 => Union<T, T1, T2, T3, T4, T5, T6, T8>.Type3(_t2),
            3 => Union<T, T1, T2, T3, T4, T5, T6, T8>.Type4(_t3),
            4 => Union<T, T1, T2, T3, T4, T5, T6, T8>.Type5(_t4),
            5 => Union<T, T1, T2, T3, T4, T5, T6, T8>.Type6(_t5),
            6 => Union<T, T1, T2, T3, T4, T5, T6, T8>.Type7(_t6),
        ...
        {
            8 => Union<T, T1, T2, T3, T4, T5, T6, T7>.Type1(func(_t8)),
            1 => Union<T, T1, T2, T3, T4, T5, T6, T7>.Type2(_t1),
            2 => Union<T, T1, T2, T3, T4, T5, T6, T7>.Type3(_t2),
            3 => Union<T, T1, T2, T3, T4, T5, T6, T7>.Type4(_t3),
            4 => Union<T, T1, T2, T3, T4, T5, T6, T7>.Type5(_t4),
            5 => Union<T, T1, T2, T3, T4, T5, T6, T7>.Type6(_t5),
            6 => Union<T, T1, T2, T3, T4, T5, T6, T7>.Type7(_t6),
            7 => Union<T, T1, T2, T3, T4, T5, T6, T7>.Type8(_t7),
