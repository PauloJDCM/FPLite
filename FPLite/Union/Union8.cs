...
{
    /// <summary>
    /// Creates a <see cref="Union{T1, T2, T3, T4, T5, T6, T7, T8}"/> with the given value.
    /// </summary>
    [Pure]
    public static Union<T1, T2, T3, T4, T5, T6, T7, T8> U1([DisallowNull] T1 value) =>
    ...
    /// </summary>
    [Pure]
    public static Union<T1, T2, T3, T4, T5, T6, T7, T8> U2([DisallowNull] T2 value) =>
    ...
    /// </summary>
    [Pure]
    public static Union<T1, T2, T3, T4, T5, T6, T7, T8> U3([DisallowNull] T3 value) =>
        new(V3: value, Type: UnionType.T3);

    /// <summary>
    /// Creates a <see cref="Union{T1, T2, T3, T4, T5, T6, T7, T8}"/> with the given value.
    /// </summary>
    [Pure]
    public static Union<T1, T2, T3, T4, T5, T6, T7, T8> U4([DisallowNull] T4 value) =>
        new(V4: value, Type: UnionType.T4);

    /// <summary>
    /// Creates a <see cref="Union{T1, T2, T3, T4, T5, T6, T7, T8}"/> with the given value.
    /// </summary>
    [Pure]
    public static Union<T1, T2, T3, T4, T5, T6, T7, T8> U5([DisallowNull] T5 value) =>
        new(V5: value, Type: UnionType.T5);

    /// <summary>
    /// Creates a <see cref="Union{T1, T2, T3, T4, T5, T6, T7, T8}"/> with the given value.
    /// </summary>
    [Pure]
    public static Union<T1, T2, T3, T4, T5, T6, T7, T8> U6([DisallowNull] T6 value) =>
        new(V6: value, Type: UnionType.T6);

    /// <summary>
    /// Creates a <see cref="Union{T1, T2, T3, T4, T5, T6, T7, T8}"/> with the given value.
    /// </summary>
    [Pure]
    public static Union<T1, T2, T3, T4, T5, T6, T7, T8> U7([DisallowNull] T7 value) =>
        new(V7: value, Type: UnionType.T7);

    /// <summary>
    /// Creates a <see cref="Union{T1, T2, T3, T4, T5, T6, T7, T8}"/> with the given value.
    /// </summary>
    [Pure]
    public static Union<T1, T2, T3, T4, T5, T6, T7, T8> U8([DisallowNull] T8 value) =>
        new(V8: value, Type: UnionType.T8);
    ...
    public TResult Match<TResult>(Func<T1, TResult> t1Func, Func<T2, TResult> t2Func, Func<T3, TResult> t3Func,
        ...
        Func<T8, TResult> t8Func) => Type switch
    {
    ...
    public async Task<TResult> MatchAsync<TResult>(Func<T1, CancellationToken, Task<TResult>> t1Func,
        ...
        Func<T8, CancellationToken, Task<TResult>> t8Func, CancellationToken ct = default) => Type switch
    {
    ...
    /// <para><b>Note:</b> The caller is responsible for using <c>ConfigureAwait</c> if necessary.</para>
    /// </summary>
    public async Task MatchAsync(Func<T1, CancellationToken, Task> t1Act, Func<T2, CancellationToken, Task> t2Act,
        Func<T3, CancellationToken, Task> t3Act, Func<T4, CancellationToken, Task> t4Act,
        Func<T5, CancellationToken, Task> t5Act, Func<T6, CancellationToken, Task> t6Act,
        Func<T7, CancellationToken, Task> t7Act, Func<T8, CancellationToken, Task> t8Act,
