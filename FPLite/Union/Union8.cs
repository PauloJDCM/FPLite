...
namespace FPLite.Union
{
    ...
    public class Union<T1, T2, T3, T4, T5, T6, T7, T8>
    {
        ...
        /// <returns>An Option containing the result of the binding function if the Union contains a T8 value; otherwise, None.</returns>
        public Option<T> Bind8<T>(Func<T8, T> func) => _type == 8 ? Option<T>.Some(func(_t8)) : Option<T>.None;
