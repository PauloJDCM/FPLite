    ...
    where T6 : notnull
{
    ...
    public async Task<TResult> MatchAsync<TResult>(Func<T1, CancellationToken, Task<TResult>> t1Func,
        ...
        Func<T6, CancellationToken, Task<TResult>> t6Func, CancellationToken ct = default) => Type switch
    {
    ...
    public async Task MatchAsync(Func<T1, CancellationToken, Task> t1Act,
        ...
        Func<T6, CancellationToken, Task> t6Act, CancellationToken ct = default)
    {
        switch (Type)
        {
            case UnionType.T1:
