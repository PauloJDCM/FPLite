...
public class Union<T1, T2, T3, T4, T5>
{
    ...
    {
        if (_t1 is not null) return Union<TResult1, TResult2, TResult3, TResult4, TResult5>.Type1(case1(_t1));
        if (_t2 is not null) return Union<TResult1, TResult2, TResult3, TResult4, TResult5>.Type2(case2(_t2));
        if (_t3 is not null) return Union<TResult1, TResult2, TResult3, TResult4, TResult5>.Type3(case3(_t3));
        if (_t4 is not null) return Union<TResult1, TResult2, TResult3, TResult4, TResult5>.Type4(case4(_t4));
        if (_t5 is not null) return Union<TResult1, TResult2, TResult3, TResult4, TResult5>.Type5(case5(_t5));
        return Union<TResult1, TResult2, TResult3, TResult4, TResult5>.Nothing;
    }
