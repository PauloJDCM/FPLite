...
public static class EitherExtensions
{
    ...
    /// Returns with type <see cref="EitherType.Right"/> if another exception is thrown.
    /// </returns>
    public static async Task<Either<TException, Exception>> TryEitherAsyncTask<TException>(
    ...
    /// Returns with type <see cref="EitherType.Right"/> if another exception is thrown.
    /// </returns>
    public static async ValueTask<Either<TException, Exception>> TryEitherAsyncValue<TException>(
